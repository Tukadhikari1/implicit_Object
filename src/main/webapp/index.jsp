...
if(responseCheck != null){
	...
	response.setHeader("Location","response-direct.jsp?office="+ responseCheck);
}
...
pageContext.setAttribute("userid", "Tuk Adhikari");
out.println("userId attribute from pageContext:"+ pageContext.getAttribute("userid")+"<br>");
%>
 <a href="index.jsp?office=head office">Show usage of error object</a><br>
